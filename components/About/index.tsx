    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center h-full pt-10 pb-20"> 
        ...
        <div className="relative flex flex-col items-center max-w-[500px] mx-auto">
          ...
          {/* Logo */}
          <div className=""> 
            <img src={letterName.src} alt="Angli Estudio since 2018" className="h-[90%] scale-75" />
          </div>
          ...
          <div className="relative text-center flex flex-col items-center justify-center">
            ...
            <h3 className="text-[#f7ecd5] text-3xl font-extralight relative z-10"> 
              En <span className={spansStyles}>Angli Estudio</span>{" "}
              somos tu aliado <br /> estratégico en{" "}
              <span className={spansStyles}>comunicación</span> <br /> y {" "}
              <span className={spansStyles}>
            ...
            <div className="relative z-10 mt-13 flex justify-end w-[140%]">
              <button className="cursor-pointer hover:scale-105 transition-transform duration-300">
                <img src={contactButton.src} alt="Contactanos" className="h-16" />
              </button>
            </div>
