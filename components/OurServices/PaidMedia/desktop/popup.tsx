      ...
      >
        ...
        <div className=" bg-[#d85254] h-[165px] sm:h-[286px] md:h-[345px] lg:h-[458px] pt-1 lg:pt-5 animate-slide-in">
          <div className="relative flex justify-center flex-col gap-1 sm:gap-1 mb-5 sm:mb-10 md:mb-12 md:gap-2 lg:gap-3 lg:mb-13">
            ...
            />
            <button className={`hablemos absolute -bottom-5 -right-5 sm:-bottom-10 sm:right-29 md:right-42 md:-bottom-11 lg:-bottom-13 lg:right-[35%] cursor-pointer hover:scale-105 transition-transform duration-300
              ${showHook ? "hidden" : ""}
              `}
              onClick={() => {
