...
import PaidMobileHook from "./mobileHook";
...
const PaidMobilePopup = () => {
  ...
  return (
    <div>
      <article
        className={`bg-[#d85254] p-5 relative ${
      ...
      >
        ...
        <Image
          ...
          height={319}
          alt="Audiovisual"
          className="w-[75%] sm:w-[55%] md:w-[60%] mx-auto"
          priority
        />{" "}
        <p className="text-[14px] sm:text-[17px] md:text-[23px] lg:text-[23px] max-w-[90%] mx-auto text-center font-normal text-white py-3 md:py-6 leading-4.5 md:leading-6">
          ...
          audiencias y acelerar el crecimiento de tu marca. A través de anuncios
...
export default PaidMobilePopup;
