...
const PaidMobileHook = ({ showMobileHook, handleOnClick}: MobileHookProps) => {
  return (
    <article
      className={`
        ...
        <div className="sm:pt-5">
          ...
          <div className="flex flex-nowrap max-w-[80%] mx-auto gap-2 sm:gap-5 pt-5">
            <div className="w-[40%] flex flex-col gap-3">
              ...
              />
              <span className="uppercase font-light text-center text-[12px] sm:text-[16px]">
          ...
          <p className="text-center max-w-[75%] mx-auto pt-4 sm:py-10 font-light text-[#d85254] text-[14px] sm:text-xl">
