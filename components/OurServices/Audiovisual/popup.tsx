...
const AudiovisualPopup = () => {
    return (
        <article className="bg- flex flex-row items-center rounded-3xl xl:rounded-4xl text-[#f7ecd5] max-w-[365px] mx-auto sm:max-w-[630px] md:max-w-[760px] lg:max-w-[1010px] xl:max-w-[1270px] overflow-hidden animate-popup">
            <Image src={imgPopup} width={533} height={1363} alt="Imagen Audiovisual" className="w-[18%] h-auto z-200 bg-[#4c80c0]"  />
            <div className="bg-[#4c80c0] h-[164px] sm:h-[284px] md:h-[343px] lg:h-[456px] xl:h-[572px] pt-3 sm:pt-5 md:pt-7 lg:pt-10 animate-slide-in">
            <div className="relative flex justify-center flex-col gap-1 mb-2 sm:gap-4 sm:mb-4 lg:gap-5 xl:gap-8 xl:mb-4 z-150">
                <Image src={titulo.src}  width={1328} height={319} alt="Audiovisual" className="w-[50%] sm:w-[53%] xl:w-[50%] mx-auto"/>
                ...
                <p className="text-[6px] sm:text-[10px] md:text-[13px] lg:text-[16px] xl:text-[20px] uppercase max-w-[60%] text-center mx-auto font-extralight mb-1 sm:mb-1 lg:mb-3
                xl:mb-0" >
