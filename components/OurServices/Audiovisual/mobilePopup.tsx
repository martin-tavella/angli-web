  ...
  return (
    ...
    <article className={`bg-[#4c80c0] p-5 ${showMobileHook ? "rounded-t-xl" : "rounded-xl"} pb-20 md:pb-27 max-w-full md:max-w-[80%] mx-auto`}>
      <Image
        ...
        height={319}
        alt="Audiovisual"
        className="w-[85%] sm:w-[90%] md:w-[80%] mx-auto"
        priority
      />{" "}
      <p className="text-[14px] sm:text-[17px] md:text-[23px] lg:text-[23px] max-w-[90%] mx-auto text-center font-normal text-white py-3 md:py-6 leading-4.5 md:leading-6">
        Nos especializamos en <strong>crear contenido</strong> audiovisual de <strong>alta calidad</strong> para 
        <strong> potenciar tu marca, fortalecer tu identidad</strong> y ayudarte a <strong>alcanzar tus objetivos</strong>
      </p>
